...
export default function Footer() {
    ...
    return <>
    <footer className="w-full  p-4 md:p-6 bg-gray-900 text-white">
      ...
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/5">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">Welcome</tspan>
                    </text>
                  </g>
                </g>
              </svg>
            ...
            Unleash the thrill of anonymous messaging with Mystery Message. Connect, share, and communicate without revealing your identity. Stay mysterious!
            </p>
          </div>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              ...
              <li><a href="https://github.com/sahilbisht890" className="hover:text-blue-400">Contact Us</a></li>
            </ul>
          </div>
          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <a href="https://github.com/sahilbisht890" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
